 ...
 */
GNMAX_API gnmax_source_cc_sptr gnmax_make_source_cc (int bias, int ant, float freq, int bw, int zeroif);
...
private:
   ...
   * \brief
   */
  gnmax_source_cc (int bias, int ant, float freq, int bw, int zeroif);  	// private constructor
