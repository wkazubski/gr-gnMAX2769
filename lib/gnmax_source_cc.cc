...
gnmax_make_source_cc (int bias, int ant, float freq, int bw, int zeroif)
{
  return gnuradio::get_initial_sptr(new gnmax_source_cc (bias, ant, freq, bw, zeroif));
}
 ...
 */
gnmax_source_cc::gnmax_source_cc (int bias, int ant, float freq, int bw, int zeroif)
  : gr::block ("gnmax_cc",
